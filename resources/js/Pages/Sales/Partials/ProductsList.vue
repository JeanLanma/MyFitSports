        ...
        <div class="flex flex-col justify-center h-full">
            ...
            <div class="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                <header class="px-5 py-4 border-b border-gray-100 flex flex-col md:flex-row justify-between">
                    <h2 class="font-bold text-gray-800 text-2xl">Ventas</h2>
                        ...
                        <table class="table-auto w-full">
                            <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                                <tr>
                                    ...
                                    <th class="p-2 whitespace-nowrap">
                                        <div class="font-semibold text-left">impuesto %</div>
                                    </th>
                                    <th class="p-2 whitespace-nowrap">
                                        <div class="font-semibold text-left">descuento %</div>
                                    </th>
                                    <th class="p-2 whitespace-nowrap">
