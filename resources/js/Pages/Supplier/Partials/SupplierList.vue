...
<DialogModal :show="ShowUpdateProductModal" @close="CloseUpdateProductModal">
        ...
        <div class="flex flex-col justify-center h-full">
            ...
            <div class="w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                <header class="px-5 py-4 border-b border-gray-100 flex flex-col md:flex-row justify-between">
                    <h2 class="font-bold text-gray-800 text-2xl">Lista de Proveedores</h2>
                    ...
                    <NavigationButton :visit="route('supplier.create')" class="max-w-md text-sky-600 hover:text-white hover:bg-sky-600">
                        Añadir nuevo
                    </NavigationButton>
                </header>
                <div class="p-3">
                            ...
                            <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                                <tr>
                                    <th class="p-2 whitespace-nowrap">
                                        <div class="font-semibold text-left">Familia</div>
                                    </th>
                                    <th class="p-2 whitespace-nowrap">
                                        <div class="font-semibold text-left">Razon social</div>
                                    </th>
                                    <th class="p-2 whitespace-nowrap">
                                        <div class="font-semibold text-left">Nombre comercial</div>
                                    </th>
                                    <th class="p-2 whitespace-nowrap">
                                    ...
                                    <th class="p-2 whitespace-nowrap">
                                        <div class="font-semibold text-left">Forma de pago</div>
                                    </th>
                                    <th class="p-2 whitespace-nowrap">
                                        <div class="font-semibold text-left">Dias de credito</div>
                                    </th>
                                    <th class="p-2 whitespace-nowrap hidden">
                                        <div class="font-semibold text-left">Tipo solcitud</div>
                                    </th>
                                    <th class="p-2 whitespace-nowrap">
                                        <div class="font-semibold text-left">Tipo sello</div>
                                    </th>
                                    <th  class="p-2 whitespace-nowrap">
                                ...
                                <tr v-for="inv in inventory" :key="inv.id" class="h-14 hover:bg-sky-300 hover:shadow-md">
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="font-bold text-gray-700">ABARROTES</div>
                                        </div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="text-gray-700">ABARROTES RAUL SA DE CV</div>
                                        </div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class=" text-gray-700">ABARROTES RAUL</div>
                                        </div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="text-gray-700">HYRAM</div>
                                        </div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="text-gray-700 font-semibold">3314324619</div>
                                        </div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap cursor-default">
                                        TRANSFERENCIA
                                    </td>
                                    <td class="p-2 whitespace-nowrap cursor-default font-semibold text-center">
                                        <span class="py-1 px-3" :class="GetStatusColor(inv.status)">
                                            N/A
                                        </span>
                                    </td>
                                    <td class="p-2 whitespace-nowrap cursor-default font-semibold hidden ">
                                        PAGINA INTERNET
                                    </td>
                                    ...
                                    <td class="p-2 whitespace-nowrap cursor-default">
                                        ...
                                        <a :href="route('inventory.show', inv.id)" class="py-1 text-center text-green-600  rounded-lg font-medium hover:text-white duration-150 underline hover:no-underline hover:bg-green-600  underline-offset-2">Ver detalle</a>
                                        <a :href="route('inventory.show', inv.id)" class="py-1 text-center text-sky-600  rounded-lg font-medium hover:text-white duration-150 underline hover:no-underline hover:bg-blue-500  underline-offset-2">Modificar</a>
                                        <a :href="route('inventory.show', inv.id)" class="text-center text-red-600  rounded-lg font-medium  hover:text-white duration-150 underline hover:no-underline hover:bg-red-500 underline-offset-2">Eliminar</a>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
   ...
   <div v-if="true" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white p-6 rounded shadow w-full lg:w-1/2">
        <h2 class="text-xl font-semibold mb-4">Editar proveedor</h2>
        <p class="text-gray-700">
            <form class=" grid grid-cols-2 gap-4">
                <div class="grid grid-cols-1">
                <InputLabel for="category" value="Familia"/>
                     <TextInput id=""  class="w-full"/>
                    </div>
                    <div class="grid grid-cols-1">
                <InputLabel for="category" value="Razon Social"/>
                     <TextInput id=""  class="w-full"/>
                    </div>
                    <div class="grid grid-cols-1">
                <InputLabel for="category" value="Nombre Comercial"/>
                     <TextInput id=""  class="w-full"/>
                    </div>
                    <div class="grid grid-cols-1">
                <InputLabel for="category" value="Contacto"/>
                     <TextInput id=""  class="w-full"/>
                    </div>
                    <div class="grid grid-cols-1">
                <InputLabel for="category" value="Forma de pago"/>
                     <TextInput id=""  class="w-full"/>
                    </div>
                    <div class="grid grid-cols-1">
                <InputLabel for="category" value="Días de crédito"/>
                     <TextInput id=""  class="w-full"/>
                    </div>
                    <div class="grid grid-cols-1 w-full">
                <InputLabel for="category" value="Tipo de sello"/>
                     <select id="" class="">
                        <option value="Pagado">RECIBIDO / PAGADO</option>
        ...
        <button @click="alert('Guardar cambios')" class="mt-4 bg-red-600 text-white px-4 py-2 rounded ">
            Atras
        </button>
        <button @click="alert('Guardar cambios')" class="mt-4 bg-blue-600 text-white px-4 py-2 rounded">
            Guardar
        </button>
        </div>
