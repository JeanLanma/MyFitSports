...
<Head title="Bienvenido" />
    ...
    <header class="w-dvw absolute top-0 left-1/2 -translate-x-1/2 z-[1000] py-4">
        <div class="max-w-[120rem] text-gray-50 px-6 md:px-8 lg:px-10">
            <nav class="w-full flex flex-row items-center font-sans">
                <a class="text-gray-50" href="/"><svg class="h-8 w-8" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="94" y="81" width="40" height="350" fill="currentColor"></rect><rect x="264" y="81" width="40" height="350" fill="currentColor"></rect><circle cx="199" cy="131" r="50" fill="currentColor"></circle><circle cx="199" cy="246" r="50" fill="currentColor"></circle><circle cx="369" cy="131" r="50" fill="currentColor"></circle><circle cx="369" cy="246" r="50" fill="currentColor"></circle></svg></a>
                <div class="flex-1 relative hidden md:flex items-center justify-center">
                    <ul class="mx-auto inline-flex gap-6 text-sm font-light">
                        <li>
                            <Link class="font-bold relative after:h-px after:content-[''] after:w-full after:absolute after:top-full after:bg-indigo-500 after:left-0 after:translate-y-1" :href="route('dashboard')">Inicio</Link>
                        </li>
                        <li>
                            <a href="">Nosotros?</a>
                        </li>
                    ...
                    <ul class="absolute right-0">
                        <li class="relative">
                            <a class=" h-10 rounded-lg flex items-center justify-center text-base bg-indigo-500 leading-none px-12 uppercase" href="">Contacto</a>
                        </li>
                    </ul>
                </div>
            </nav>
    ...
    <section class="h-dvh w-dvw max-h-[80rem] relative">
        <div class="absolute inset-0 z-[1]">
            <img class="h-full w-full object-cover object-center" src="https://github.com/Gederooney/modern-gym-landing/blob/master/bg.png?raw=true" alt="">
        </div>
        <div class="max-w-[120rem] mx-auto h-full relative z-[2] px-6 md:px-8 lg:px-10">
            <div class="h-full w-full  flex flex-col relative space-y-6">
                <div class="mt-auto mb-0 text-gray-50 md:pb-36 space-y-6">
                    <span class="font-light text-sm text-indigo-500 ">SE TU MEJOR VERSIÓN</span>
                    <h1 class="text-3xl md:text-5xl max-w-[30rem] font-medium">My Smart Fitness</h1>
                    <p class="max-w-[30rem] font-light ml-4 before:content-[''] relative before:absolute before:w-px before:h-full before:left-0 before:top-0 before:-translate-x-4 before:bg-indigo-500 md:text-base text-sm">Empieza a ver resultados reales y alcanza tus metas de fitness con My Fit Sports.</p>
                    <div class="md:flex-row flex-col flex gap-4">
                        <Link :href="route('dashboard')">
                            <button class="inline-block text-base font-medium px-12 py-2 bg-indigo-400 rounded-lg cursor-pointer">
                                Comenzar ahora        
                            </button>
                        </Link>

                        <!-- <button class="hidden inline-block text-base font-medium px-12 py-2 border border-indigo-400 rounded-lg text-indigo-400 cursor-pointer bg-gray-50/10 backdrop-blur-3xl">Nos Horaires</button> -->
                    </div>
                </div>
                <div class="md:absolute md:right-0 md:bottom-32 text-gray-50 my-16">
                    <ul class="flex md:flex-col items-center justify-center gap-2">
                        <li class="h-6 w-6 block rounded-full bg-indigo-400 text-gray-50">
